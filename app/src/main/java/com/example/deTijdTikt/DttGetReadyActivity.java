...
public class DttGetReadyActivity extends AppCompatActivity implements SpeechRecognitionManager.SpeechRecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dtt_get_ready);
    ...
    public void speakTextClarification() {
        ...
        speechHelper.speak("Pak de ballen en maak een kring zodat je de ballen naar elkaar over kan gooien.", new SpeechHelper.SpeechCompleteListener() {
            @Override
            public void onSpeechComplete() {
                Log.d("Speech", "Speech synthesis voltooid");
                setButtonsClickable(true);
