...
public class DttIntensityActivity extends AppCompatActivity implements SpeechRecognitionManager.SpeechRecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dtt_intensity);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.activity_dtt_intensity), (v, insets) -> {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!selectedIntensities.isEmpty()) {
                    ...
                    Toast.makeText(DttIntensityActivity.this, "Selecteer minimaal één intensiteit", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void toggleIntensitySelection(int intensity) {
        if (selectedIntensities.contains(intensity)) {
            ...
            Log.d("DttIntensity", "Removed intensity level: " + intensity + ". Current selection: " + selectedIntensities);
        } else {
            selectedIntensities.add(intensity);
            Log.d("DttIntensity", "Added intensity level: " + intensity + ". Current selection: " + selectedIntensities);
        }
